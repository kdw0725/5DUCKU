	...
	<div class="bg0 p-b-140">
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-80 p-b-50 p-lr-15-lg w-full-md m-lr-auto" id="findPwArea">
					...
					<div class="bor8 m-b-40 how-pos4-parent">
						<input class="stext-111 cl2 plh3 size-116 p-l-30 p-r-30" type="text" placeholder="아이디" name="member_id" required="required" onKeypress = "noBlank()">
					</div>
					<div class="bor8 m-b-40 how-pos4-parent">
					...
					<button type="button" class="flex-c-m stext-101 cl0 size-121 bg1 bor1 hov-btn1 p-lr-15 m-t-40 trans-04 pointer" id="findPw">비밀번호 찾기</button>
				</div>
			</div>
		</div>
	</div>
