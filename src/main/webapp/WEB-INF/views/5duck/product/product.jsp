...
<section class="bgwhite p-t-60">
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid" style="position: relative; height: 1717.4px;" id="productArea">
					...
					<div class="block2">\
						...
						<div class="block2-txt flex-w flex-t p-t-14">\
							<div class="block2-txt-child1 flex-col-l ">\
								<a href="product/'+productData.pro_code+'" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">\
								...
								<span class="stext-105 cl3">\
								by.'+productData.seller_name+'\
							</span>\
							</div>\
							<div class="block2-txt-child2 flex-r p-t-3">\
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">\
									<img class="icon-heart1 dis-block trans-04" src="/mainresources/bootstrap/images/icons/icon-heart-01.png" alt="ICON">\
									<img class="icon-heart2 dis-block trans-04 ab-t-l" src="/mainresources/bootstrap/images/icons/icon-heart-02.png" alt="ICON">\
								</a>\
							</div>\
						</div>\
					</div>\
